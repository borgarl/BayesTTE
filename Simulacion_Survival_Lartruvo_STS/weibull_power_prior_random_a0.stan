...
parameters {
  ...
  real<lower=0, upper=1> a0;  // Weight power prior
...
model {
  ...
  a0 ~ uniform(0, 1);  // Weight power prior
...
generated quantities {
  real HR;
  real used_a0 = a0; // Output the value of a0
  int used_N_external = N_external; // Output the number of external patients
