...
gen_surv_data <- function(pat, parameters, 
  ...
  # shape_parameter <- c(0.7992308, 0.813522)
  # 
  # 
  # # Valor del scale para cada uno de los brazos
  # 
  # parameters <- c(11.90518, 16.94963)
  ...
  for (arm in arms) {
    ...
    censor_times[pat$arm == arm] <- rexp(n, rate = 1 / (quantile(event_times[pat$arm == arm], 1 - censor[arm])))
